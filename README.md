...
```javascript
kruskalTest = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-kruskal-test@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-kruskal-test@umd/bundle.js"></script>
```
